...
class OrderRepository extends BaseOrderRepository implements OrderRepositoryInterface
{
     ...
     * {@inheritdoc}
     */
    public function createsellerByCustomerIdQueryBuilder($customerId): QueryBuilder
    {
        return $this->createQueryBuilder('o')
            ->andWhere('o.customer = :customerId')
            ->andWhere('o.getShippingAddress.CountryCode = : countrycode')
            ->andWhere('o.state != :state')
            ->setParameter('countrycode', 'SN')
    ...
    public function findCartForAddressing($id): ?OrderInterface
    {
        ...
        $order = $this->createQueryBuilder('o')
            ...
            ->getOneOrNullResult()
        ;
        //$order->setChannel($this->findOneBy(array('code'=>'WEB_EU')));
