...
final class AccountMenuBuilder
{
    ...
    public function __construct(FactoryInterface $factory, EventDispatcherInterface $eventDispatcher, CustomerContext $customer)
    {
    ...
    public function createMenu(array $options): ItemInterface
    {
        ...
        ;
        if(!$this->customer->getCustomer()->getUser()->hasRole('ROLE_SELLER')){
        $menu
